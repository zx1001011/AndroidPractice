...
import com.david.www.task6.MainActivity;
...
public class DatabaseProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.david.www.task6.provider";
...
// 删除数据
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case BOOK_DIR:
                return "vnd.android.cursor.dir/vnd.com.david.www.task6. provider.book";
            case BOOK_ITEM:
                return "vnd.android.cursor.item/vnd.com.david.www.task6. provider.book";
            case CATEGORY_DIR:
                return "vnd.android.cursor.dir/vnd.com.david.www.task6. provider.category";
            case CATEGORY_ITEM:
                return "vnd.android.cursor.item/vnd.com.david.www.task6. provider.category";
        }
        return null;
    }
}
